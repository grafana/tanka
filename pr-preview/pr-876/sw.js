...
self.__precacheManifest = [
  ...
  {
    "url": "styles.e0a6dda27f809273d2fd.css"
  },
  {
  ...
  {
    "url": "app-f69d80f4647c95a2f842.js"
  },
  {
  ...
  },
  {
    ...
    "revision": "02a8e3b819563f286e8a7c8371766240"
  }
...
const navigationRoute = new NavigationRoute(async ({ event }) => {
  ...
  pathname = pathname.replace(new RegExp(`^/pr-preview/pr-876`), ``)

  // Check for resources + the app bundle
  // The latter may not exist if the SW is updating to a new version
  const resources = await idbKeyval.get(`resources:${pathname}`)
  if (!resources || !(await caches.match(`/pr-preview/pr-876/app-f69d80f4647c95a2f842.js`))) {
    return await fetch(event.request)
  }
  ...
  const offlineShell = `/pr-preview/pr-876/offline-plugin-app-shell-fallback/index.html`
