...
// controller set to true, i.e. it is a child object whose lifecycle is
// managed by another object's controller (e.g. a Secret generated by
// external-secrets from an ExternalSecret).
func (m Metadata) HasControllerOwner() bool {
