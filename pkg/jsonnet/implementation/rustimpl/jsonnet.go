// Taken from https://github.com/strickyak/jsonnet_cgo/blob/master/jsonnet.go
...
func (v *JsonValue) Extract() interface{} {
	cstr := C.jsonnet_json_extract_as_json_string(v.vm.guts, v.guts)
