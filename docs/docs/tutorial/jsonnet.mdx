...
> Jsonnet. Alternatively, you can create the namespace manually:
>
> ```bash
> $ kubectl create ns monitoring
> ```
>
> This, however, will create an object that is not tracked by the configuration
> used by Tanka and thus needs to be taked care of via other means.
