...
> Jsonnet. Using ksonnet lib (mentioned in [Kubernetes library](/tutorial/k-lib)
> section), the following snippet will take care of the namespace creation:
> ```json
> {
>   my_namespace: $.core.v1.namespace.new('my-namespace'),
> }
> ```
>
